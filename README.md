...
- **F1** - показать/скрыть вспомогательные окна (слайдер скорости и шпаргалка)
...
### Скорость симуляции
- **F1** — открыть/скрыть окно управления скоростью
- Слайдер в окне: от **0.1x** до **1000x**, логарифмическая шкала
- **[ / ]** — замедлить / ускорить шагом 0.25x
- **\\** — сбросить скорость до 1x
- Пока курсор над окнами egui, клики и клавиши не передаются в игру (не сработает выбор танка)
